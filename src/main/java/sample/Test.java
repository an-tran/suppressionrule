...
//        String file = Test.class.getClassLoader().getResource("basic-expr").getPath();
//        suppressionLexer lexer = new suppressionLexer(CharStreams.fromFileName("D:\\project\\suppressionrule\\src\\main\\resources\\basic-expr"));
